...
export default function Explorer() {
	...
	return (
		...
		<Grid item xs={2} sx={{height:"100%"}} className="shadow">
		 ...
		 <div className="list-item" ref={history} onClick={(e)=>{changeActive(history,activeElement,setActiveElement);setRightComponent(<HistoryContainer />)}}><History className="icon"/><span className="responsive-menu"> <Typography sx={{ fontWeight: 500 ,display:"inline"}}> &nbsp;Histories</Typography sx={{ fontWeight: 500 ,display:"inline"}}></span></div>
